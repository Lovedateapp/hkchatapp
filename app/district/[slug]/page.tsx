...
export default function DistrictPage({ params }: { params: { slug: string } }) {
  ...
  const districtSlug = params.slug
  const districtName = getDistrictName(districtSlug)
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        console.error("Error fetching posts by district:", err)
    ...
    <div className="container mx-auto py-6 px-4">
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-10">
              <p className="text-muted-foreground mb-4">暫無 {districtName} 地區的貼文</p>
